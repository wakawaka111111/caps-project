...
<body>
    ...
    <div class="services-container">
        <div class="service-box">
            <h3>Hair Cutting</h3>
            <p>Professional haircuts by skilled stylists.</p>
            <p>Price: ₱500 - ₱1,000</p>
            <a href="technicians.php?service=Hair_cutting" class="book-btn">Book Now</a>
        </div>
        <div class="service-box">
            <h3>Hair Styling</h3>
            <p>Creative styling for all occasions.</p>
            <p>Price: ₱300 - ₱800</p>
            <a href="technicians.php?service=Hair_styling" class="book-btn">Book Now</a>
        </div>
        <div class="service-box">
            <h3>Coloring</h3>
            <p>High-quality hair coloring services.</p>
            <p>Price: ₱1,000 - ₱3,000</p>
            <a href="technicians.php?service=Hair_coloring" class="book-btn">Book Now</a>
        </div>
        <div class="service-box">
            <h3>Treatments</h3>
            <p>Rejuvenating hair treatments for healthy hair.</p>
            <p>Price: ₱800 - ₱2,000</p>
            <a href="technicians.php?service=Hair_treatments" class="book-btn">Book Now</a>
        </div>
    </div>
</body>
</html>