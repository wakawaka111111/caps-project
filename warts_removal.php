...
<body>
    ...
    <div class="services-container">
        <!-- Specific Warts Removal Services -->
        <div class="service-box">
            <h3>Laser Wart Removal</h3>
            <p>Effective and safe wart removal through laser technology.</p>
            <p>Price: ₱1,500 - ₱3,000 per session (Multiple sessions may be required for complete removal)</p>
            <a href="technicians.php?service=laser_wart_removal" class="book-btn">Book Now</a>
        </div>
    </div>
</body>
</html>