...
<body>
    ...
    <div class="services-container">
        <!-- Specific Hair Extensions Services -->
        <div class="service-box">
            <h3>Clip-In Extensions</h3>
            <p>Temporary clip-in extensions for a natural look.</p>
            <p>Price: ₱2,500 - ₱5,000 (depending on length and quality of hair)</p>
            <a href="technicians.php?service=clip_in_extensions" class="book-btn">Book Now</a>
        </div>
        <div class="service-box">
            <h3>Tape-In Extensions</h3>
            <p>Long-lasting tape-in extensions for fuller hair.</p>
            <p>Price: ₱3,500 - ₱7,000 (depending on length and quality of hair)</p>
            <a href="technicians.php?service=tape_in_extensions" class="book-btn">Book Now</a>
        </div>
    </div>
</body>
</html>